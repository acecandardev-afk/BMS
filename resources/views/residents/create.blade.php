...
<div class="py-4" style="max-width: 56rem;">
    ...
    <div class="d-flex align-items-center gap-3 mb-4">
        ...
        <div>
            <h2 class="h5 mb-0 bc-page-title">Add Resident</h2>
            <p class="small text-muted mb-0">Register a new resident profile.</p>
        </div>
    </div>
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <select name="zone" required class="form-select form-select-sm {{ $errors->has('zone') ? 'is-invalid' : '' }}">
                        ...
                        @foreach(range(1, 10) as $zone)
                            <option value="Zone {{ $zone }}" {{ old('zone') === "Zone $zone" ? 'selected' : '' }}>
                                Zone {{ $zone }}
                            </option>
                        @endforeach
                    </select>
        ...
        <div class="card bc-card p-3 p-md-4 bc-form-panel">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <textarea name="remarks" rows="3" class="form-control form-control-sm">{{ old('remarks') }}</textarea>
                </div>
            </div>
        </div>
