...
@section('content')
    ...
    <h2 class="h5 fw-bold mb-1" style="color: var(--bc-text);">Welcome back</h2>
    <p class="small text-muted mb-4">Sign in to your account to continue.</p>

    <form method="POST" action="{{ route('login.store') }}" class="bc-auth-form">
        @csrf
    ...
    <p class="text-center small text-muted mt-4 mb-0">
        New resident? <a href="{{ route('register') }}" class="bc-link">Create an account</a>
    </p>
    <p class="text-center small text-muted mt-2 mb-0">
        Having trouble? Contact the Barangay Administrator.
    </p>
