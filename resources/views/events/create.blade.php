...
@section('title', 'Post barangay update')
...
<div class="py-3 py-md-4 mx-auto" style="max-width: 42rem;">
    ...
    <div class="d-flex align-items-start gap-3 mb-4">
        ...
        <div class="min-w-0">
            <h2 class="h5 mb-1 bc-page-title">Post update</h2>
            <p class="small text-muted mb-0">Published to the public Events page for residents and visitors.</p>
        </div>
    </div>

    <form method="POST" action="{{ route('events.store') }}" class="d-flex flex-column gap-4">
        @csrf
        ...
        <div class="card bc-card p-3 p-md-4 bc-form-panel">
            ...
            <div class="mb-0">
                ...
                <textarea name="body" id="body" rows="10" required
                          ...
                          placeholder="Write the full announcement or update for residents.">{{ old('body') }}</textarea>
                @error('body')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
        </div>

        <div class="d-flex gap-2">
            <button type="submit" class="btn btn-bc-primary">Publish</button>
