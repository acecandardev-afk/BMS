...
<body>
    ...
    <div class="control-number">
        Control No.: <strong>{{ $control_number }}</strong>
    </div>
    ...
    <p class="body-text">
        Further, this certifies that the above-named person is of good moral character, law-abiding, and
        has no derogatory record in this barangay as of this date.
    </p>
