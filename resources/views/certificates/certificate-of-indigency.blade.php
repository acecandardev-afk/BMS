...
<body>
    ...
    <p class="body-text" style="margin-top: 15px;">
        ...
        is a resident of this Barangay and is one of the <strong>indigents</strong> in our barangay.
    </p>

    <div class="indigency-note">
        <strong>This further certifies</strong> that the above-named person belongs to an
        <strong>indigent family</strong> and is one of the less fortunate constituents of this barangay.
        {{ $gender_words['possessive'] }} family's income is insufficient to meet the basic needs of their household.
    </div>

    <p class="body-text">
        This certification is being issued in connection with {{ $gender_words['possessive'] }} application for assistance
        from concerned government agencies and other institutions.
    </p>
    ...
    <table class="info-table">
        ...
        <tr>
            ...
            <td class="value">{{ $resident->occupation ?? 'None' }}</td>
            <td class="label">4Ps Beneficiary:</td>
            <td class="value">{{ $resident->is_4ps ? 'Yes' : 'No' }}</td>
        </tr>
    </table>
