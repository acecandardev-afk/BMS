...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Upload disk (resident photos, legislation, blotter attachments)
    |--------------------------------------------------------------------------
    |
    | Use "public" for local development. Set to "supabase" in production when
    | FILESYSTEM_UPLOAD_* / Supabase Storage S3 credentials are configured.
    |
    */
    ...
    */
    ...
    'disks' => [
        ...
        /*
         * Supabase Storage (S3-compatible). Create bucket + S3 keys in Dashboard → Storage.
